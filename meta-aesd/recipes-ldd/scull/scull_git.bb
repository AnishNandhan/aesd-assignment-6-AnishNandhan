...
SRC_URI = "git://git@github.com/AnishNandhan/aesd-assignment-7-AnishNandhan.git;protocol=ssh;branch=main \
           ...
           file://0002-change-kernel-src-variable-name.patch \
           file://scull-load-unload \
           "
...
FILES:${PN} += "${sysconfdir}/init.d/scull-load-unload"
...
INITSCRIPT_NAME:${PN} = "scull-load-unload" 

do_install:append() {
    install -d ${D}${sysconfdir}/init.d
    install -m 0755 ${WORKDIR}/scull-load-unload ${D}${sysconfdir}/init.d
}